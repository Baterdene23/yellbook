  ...
  const featureCards = [
    {
      ...
      description: "Үйлчилгээний төрөл, байршил болон түлхүүр үгээр ангилан харьцуулж үзэх боломж.",
    },
    {
    ...
    },
    {
      ...
      description: "Төр, хувийн хэвшил, төрийн бус байгууллагуудыг чиглэлээр нь ялган хараарай.",
    },
  ];
          ...
          <section id="hero" className="mt-16 grid gap-12 lg:grid-cols-[3fr_2fr] lg:items-center">
            ...
            <div className="relative">
              <div className="glass-panel relative flex flex-col gap-4 rounded-[30px] border border-border/60 p-6">
                ...
                <h3 className="text-xl font-semibold text-foreground">Түлхүүр үгээр хайна уу</h3>
