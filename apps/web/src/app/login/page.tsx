      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-8 shadow-xl">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-gray-700 hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 px-4 rounded-lg transition flex items-center justify-center space-x-3"
          >
            {loading ? (
              <>
          ...
          <div className="mt-6 p-4 bg-gray-700/50 rounded text-gray-300 text-sm">
            <p className="mb-2 font-semibold">First time here?</p>
            <p>Click the GitHub button above to create an account or sign in securely.</p>
          </div>
        </div>
